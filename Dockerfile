...
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "platforms;android-23"
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "system-images;android-23;google_apis;x86_64"
